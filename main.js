...
const app = {
    ...
    render: function () {
        const item = this.songs.map((song, index) => {
            return `
    ...
    handleEvents: function () {
        ...
        audio.ontimeupdate = function () {
            ...
            if (audio.duration) {
                musicLength.innerHTML = formatTime(audio.duration);
                musicDuration.innerHTML = formatTime(audio.currentTime)
        ...
        playlist.onclick = function (e) {
            ...
            if (songNode || e.target.closest(".option")) {
                ...
                // Xử lý khi click vào song option (chưa biết viết thêm gì :v)
